...
Coding For the Shopping Bill (Grocery)
...
public class ShoppingBill
{
    public static void main(String args[])
    {
        ...
        System.out.println("\t\t\t\t\t "+" "+"Fast N Fresh Grocery App");
        System.out.println("\t\t\t\t\t4/12 Summer street,Wolfville,Nova scotia");
        System.out.println("\t\t\t\t\t" +" " +" Canada ");
        System.out.println("GSTIN: 03AWBPP8756K592"+"\t\t\t\t\t\t\tContact: (+902) 9988776655232");
        ...
        System.out.println("Date: "+formatter.format(date)+" "+days[calendar.get(Calendar.DAY_OF_WEEK) - 1]+"\t\t\t\t\t\t (902)999888777032");
